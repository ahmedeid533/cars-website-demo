...
console.log("category ==> ", category);
  return (
    <>
      <section className="relative bg-cover bg-no-repeat bg-center mb-5 lg:mb-40 w-full h-[30vh] md:h-[60vh]"
				style={{
					backgroundImage: category ? `url(${category.image_url})` : "url('/category_name/main-bg.png')",
