...
const Details = ({ order }: { order: any }) => {
	return (
		<div id="print1" className="rounded py-10 px-5 w-full bg-white lg:bg-[#E8E8E8] flex flex-col gap-5">
			<FirstLine order={order} />
			<SecondLine order={order} />
			...
			{/* <div className="flex lg:hidden flex-col gap-2 mt-2">
				<h2 className="text-[#475156] text-sm">
					...
					<span className="text-custom-black">23 Jan, 2024</span>
				</h2>
				<CustomTimeline />
			</div> */}
		</div>
