		...
		<div className="flex flex-row items-start w-full justify-between">
			<div className="flex flex-col gap-5 w-full">
				...
				<div className="flex flex-row lg:flex-col  justify-between lg:justify-start gap-5 w-full">
					...
					<div className="flex flex-col gap-1">
						<h2 className="font-bold text-sm lg:text-xl text-custom-black ">
							{locale == "en" ? "Order Address" : "عنوان الطلب"}
						</h2>
					...
					<div className="flex flex-col gap-1">
						<h2 className="font-bold text-sm lg:text-xl text-custom-black ">
							{locale == "en" ? "Paid by" : "مدفوع بواسطة"}
						</h2>
						{/* <Image
							src={"/orders/visa.svg"}
							alt="visa"
			...
			<div className="flex rounded-xl p-4 flex-col gap-3 w-1/3 bg-white text-custom-black">
				...
				<p className="text-sm font-bold mb-2 text-ellipsis overflow-hidden max-h-[10vh]">
					{order?.notes}
				</p>
				<div
					onClick={() => {
				...
				>
					{locale == "en" ? "Edit Notes" : "تعديل الملاحظات"}
				</div>
			</div>
			{open && (
