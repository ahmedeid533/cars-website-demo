        ...
        >
            <Fade in={open}>
                <div className='z-[100] border-none outline-none'>
                    <div className='top-[50%] left-[50%] absolute flex flex-col gap-3 border-none outline-none w-[85%] lg:w-1/3' style={{ transform: "translate(-50%, -50%)" }}>
                        <div className='relative flex flex-col justify-start items-start gap-3 bg-white p-6 rounded'>
                            ...
                            <div className="flex justify-between items-center mt-5 w-full">
                                <h2 className='from-black text-custom-black text-lg'>My Garage</h2>
